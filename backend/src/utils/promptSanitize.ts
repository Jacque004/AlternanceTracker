/** Bornes d’entrée pour les prompts LLM (coût + injection). */
...
/**
 * Neutralise les caractères de contrôle et les balises de rôle LLM.
 * Ne censure pas des mots métier (ex. « système », « ignore ») pour ne pas casser un CV.
 */
