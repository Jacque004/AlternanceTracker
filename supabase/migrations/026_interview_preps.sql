-- Préparation d’entretien liée à une candidature (questions + points CV)
...
COMMENT ON TABLE interview_preps IS 'Questions probables et points du CV à citer pour un entretien';
